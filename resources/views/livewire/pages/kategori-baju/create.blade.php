...
new class extends Component {
    ...
    {
        $this->validate([
            'nama_kategori' => 'required|string|max:255|unique:kategori_bajus,nama_kategori',
        ]);
        ...
        session()->flash('message', __('Kategori berhasil dibuat.'));
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="mb-4 sm:mb-0">
                    ...
                    <p class="mt-2 text-lg text-gray-600 dark:text-gray-300">
                        {{ __('Tambahkan kategori baru untuk sistem inventori') }}
                    </p>
                </div>
